...
-- # elements
local Window = Library:CreateWindow({ Title = 'Mint Hub', Center = true, AutoShow = true }) do
    local Tabs = { Main = Window:AddTab('Main'), ['UI Settings'] = Window:AddTab('UI Settings') } do
        ...
        local section = Tabs.Main:AddRightTabbox('Credits'):AddTab('Credits') do
            section:AddLabel('Creator: <font color="#3EB489">Trustsense</font>')

            section:AddLabel('Interface: <font color="#ADD8E6">wally</font>')
        end
